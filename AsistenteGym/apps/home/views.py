...
class IndexView(ListView): #heredamos de la vista generica TemplateView
	...
	def get_context_data(self, **kwargs):
		...
		context['total_questions'] = Question.objects.count()#pido que me traiga cuantos objetos tiene este modelo
